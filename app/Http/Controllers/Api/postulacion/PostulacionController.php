		...
		if($post['run']!=""){
			...
			try{
				...
				// else{
					// if(isset($post["postula_examinador"]) && $post["postula_examinador"]=='true'){
						// $cargo .= "examinador, ";
						// $personaCargo = PersonaCargo::where("id_persona", $persona->id_persona)->where("id_rol_proceso", 8)->first();
						// if(!isset($personaCargo->id_persona_cargo)){
							// $personaCargo = new PersonaCargo();
							// $personaCargo->id_persona = $persona->id_persona;
							// $personaCargo->id_rol_proceso = 8;
							// $personaCargo->reclutamiento = true;
							// $personaCargo->save();
						// }
					// }
					// if(isset($post["postula_examinador"]) && $post["postula_examinador"]=='false'){
						// $personaCargo = PersonaCargo::where("id_persona", $persona->id_persona)->where("id_rol_proceso", 8)->first();
						// if(isset($personaCargo->id_persona_postula)){
							// $personaCargo->delete();
						// }
					// }
					...
					// if(isset($post["postula_supervisor"]) && $post["postula_supervisor"]=='true'){	
						// $cargo .= "supervisor, ";
						// $personaCargo = PersonaCargo::where("id_persona", $persona->id_persona)->where("id_rol_proceso", 9)->first();
						// if(!isset($personaCargo->id_persona_postula)){
							// $personaCargo = new PersonaCargo();
							// $personaCargo->id_persona = $persona->id_persona;
							// $personaCargo->id_rol_proceso = 9;
							// $personaCargo->reclutamiento = true;
							// $personaCargo->save();
						// }
					// }
					...
					// if(isset($post["postula_examinador_apoyo"]) && $post["postula_examinador_apoyo"]=='true'){	
						// $cargo .= "examinador de apoyo, ";
						// $personaCargo = PersonaCargo::where("id_persona", $persona->id_persona)->where("id_rol_proceso", 1007)->first();
						// if(!isset($personaCargo->id_persona_postula)){
							// $personaCargo = new PersonaCargo();
							// $personaCargo->id_persona = $persona->id_persona;
							// $personaCargo->id_rol_proceso = 1007;
							// $personaCargo->reclutamiento = true;
							// $personaCargo->save();
						// }
					// }
					...
					// if(isset($post["postula_anfitrion"]) && $post["postula_anfitrion"]=='true'){
						// $cargo .= "anfitrión, ";	
						// $personaCargo = PersonaCargo::where("id_persona", $persona->id_persona)->where("id_rol_proceso", 1006)->first();
						// if(!isset($personaCargo->id_persona_postula)){
							// $personaCargo = new PersonaCargo();
							// $personaCargo->id_persona = $persona->id_persona;
							// $personaCargo->id_rol_proceso = 1006;
							// $personaCargo->reclutamiento = true;
							// $personaCargo->save();
						// }
					// }
